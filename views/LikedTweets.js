...
const LikedTweets = {
    render: () => {
        ...
        <ul class="list">
        ${likedTweets.map(tweet => `<li class="list-item_liked"><a href="#/edit/${likedTweets.indexOf(tweet)}">${tweet.content}</a>
        <a class="liked-btn"><i class="fas fa-heart fa-lg liked"></i></a></li>`
        ).join('\n ')}
        </ul>
        </section>`;
        return view;
